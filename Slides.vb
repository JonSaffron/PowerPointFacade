' Slides is a 1 based collection of the object Slide
Public Class Slides
    Implements IEnumerable(Of Slide)
    Implements IEnumerator(Of Slide)
    Implements IDisposable

    Private ReadOnly _slides As Object

    Friend Sub New(ByVal slides As Object)
        Me._slides = slides
        Call Me.Reset()
    End Sub
